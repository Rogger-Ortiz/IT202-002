...
<tr><td> <em>Generated: </em> 2/15/2022 12:18:02 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/init-db-setup/grade/ro77" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98473695/154113164-be03f3bf-e875-450c-a02f-db4f1edeca2d.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>This is the working init_dp file, on heroku<br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98473695/154113377-fc66895c-97fc-4132-b111-4b89b26b33c7.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>This is the database as it appears in VSCode<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I refined my skills in navigating Heroku and Github. I still am finding<br>my way around, and it is definitely taking some time to get used<br>to. However, I learned about how the init_db works (from your video and<br>in class) as well as what I might expect to see during my<br>time with this project.<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I accidentally named the file &quot;init_dp.php&quot; and that stumped me for a while<br>because the file was not showing in Heroku. Nonetheless, I renamed the file<br>(as you can see in the pull request) and it worked.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Add the pull request link (ProjectSetup to Dev)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/Rogger-Ortiz/IT202-002/pull/7">https://github.com/Rogger-Ortiz/IT202-002/pull/7</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ro77-dev.herokuapp.com/Project/sql/init_db.php">https://ro77-dev.herokuapp.com/Project/sql/init_db.php</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/init-db-setup/grade/ro77" target="_blank">Grading</a></td></tr></table>