...
<tr><td> <em>Generated: </em> 2/11/2022 12:23:18 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/m2-php-hw/grade/ro77" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98473695/153637382-beadcfd3-ba8d-4020-99e3-1f8b38b7b26e.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Odd Outputs using a for() loop, and if() statement, and the mod (%)<br>operator.<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>The modulus operator returns the remainder of the division. Odd numbers will always<br>=1 if %2. So if(%2=1), then it is odd, and echo it.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98473695/153637697-76518b84-3a32-45ef-90a7-67609cf062d6.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Sum of the arrays in a floating number format<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>using the number_format as well as rounding the numbers to 2 places, I<br>was able to make sure that there are always 2 decimals, as well<br>as add the floating numbers without error.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98473695/153638083-23114144-4422-4060-8b3b-a0d23788834c.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Turn all outputs positive.<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 2: </em> Describe how you solved the problem</td></tr>
<tr><td> <em>Response:</em> <p>Using the abs() function, I took the absolute value of each entry and<br>returned it. It will always be positive by the nature of absolute values.<br></p><br></td></tr>
</table></td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ro77-dev.herokuapp.com/M2/problem1.php">https://ro77-dev.herokuapp.com/M2/problem1.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ro77-dev.herokuapp.com/M2/problem2.php">https://ro77-dev.herokuapp.com/M2/problem2.php</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://ro77-dev.herokuapp.com/M2/problem3.php">https://ro77-dev.herokuapp.com/M2/problem3.php</a> </td></tr>
<tr><td> <em>Sub-Task 4: </em> Pull Request URL for M2-PHP-HW to dev</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/Rogger-Ortiz/IT202-002/pull/4">https://github.com/Rogger-Ortiz/IT202-002/pull/4</a> </td></tr>
<tr><td> <em>Sub-Task 5: </em> Talk about what you learned, any issues you had, how you resolve them</td></tr>
<tr><td> <em>Response:</em> <p>I learned how to use PHP, since this is my first time using<br>it, as well as the number_format and round functions used in problem 2.<br>Since it is so much like java (a language I am very familiar<br>with) I was able to catch up well. I did not come across<br>any problems, however, but I did find it helpful to use w3schools built-in<br>PHP compiler to help test my code and make sure it worked before<br>committing the changes.<br></p><br></td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-002-S22/m2-php-hw/grade/ro77" target="_blank">Grading</a></td></tr></table>