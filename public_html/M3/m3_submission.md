...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98473695/154186834-6cf4e3a0-c711-4f5c-b3e7-ceab90967aa0.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Register anchor<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 4: </em> Screenshot showing after the profile link is clicked (be sure to include the url)</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98473695/154186877-a82072be-657e-405e-8a0b-ab129f2ceeac.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Profile anchor<br></p>
</td></tr>
</table></td></tr>
<tr><td> <em>Sub-Task 5: </em> Screenshot showing after the logout link is clicked (be sure to include the url)</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/98473695/154186926-68127b62-ce24-42af-a2d6-620a23fd9aee.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Logout anchor<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>floated all the &quot;nav, ul, li&quot; tags left. You could also put them<br>in a table but i did not do it this way.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 2: </em> Briefly explain how you remove the navigation list item markers</td></tr>
<tr><td> <em>Response:</em> <p> list-style-type none. Removes the style of the list.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Briefly explain how you gave the navigation a background</td></tr>
<tr><td> <em>Response:</em> <p>backgorund-color: ###### gives it a background color of users choice.<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>a:hover lets the CSS change when the clinet hovers over link<br></p><br></td></tr>
<tr><td> <em>Sub-Task 5: </em> Briefly explain how you changed the challenge list bullet points to checkmarks (✓)</td></tr>
<tr><td> <em>Response:</em> <p>list-style-type, then used the checkmark.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 6: </em> Briefly explain how you made the first character of the h1 tags and anchor tags uppercased</td></tr>
<tr><td> <em>Response:</em> <p>by using text-transform: capitalize on the h1 and a tags, you can capitalize<br>the words in them.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 7: </em> Briefly explain/describe your custom styling of your choice</td></tr>
<tr><td> <em>Response:</em> <p>I chose a background color for the body, as well as changed the<br>entire box on a:hover. I thought black text would look better on the<br>yellow instead of the white.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 8: </em> Briefly explain how the styling for the challenge list doesn't impact the navigation list</td></tr>
<tr><td> <em>Response:</em> <p>i implicitly defined the order of the tags in which certain elements were<br>affected (i.e. i used &quot;ul li ul li&quot; to determine the checklist, because<br>that is how the tags were wrapped around it<br></p><br></td></tr>
<tr><td> <em>Sub-Task 9: </em> Briefly explain how you updated the content of the h1 tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>This was harder, I parsed the anchor name from the url and then<br>passed that into updateCurrentPage. However this did not work too well since the<br>changes appeared upon reloading the page, not imeediately.<br></p><br></td></tr>
<tr><td> <em>Sub-Task 10: </em> Briefly explain how you updated the content of the title tag with the link text</td></tr>
<tr><td> <em>Response:</em> <p>the same as above, just apply it to the title tag.<br></p><br></td></tr>
</table></td></tr>
